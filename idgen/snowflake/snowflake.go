...
func (f ID) IntBytes() [8]byte {
	var b [8]byte
	binary.BigEndian.PutUint64(b[:], uint64(f)) //nolint:gosec // G115: snowflake IDs are always positive
	return b
}
...
func ParseIntBytes(id [8]byte) ID {
	return ID(int64(binary.BigEndian.Uint64(id[:]))) //nolint:gosec // G115: snowflake IDs fit in int64
}
